@extends('default', ['title' => 'Graduação de alunos'])
@section('content')
<style type="text/css">
	.img-profile{
		height: 120px;
...
<div class="row">
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				<a href="/graduacao/new" class="btn btn-success ml-1 mb-3">
					<i class="la la-plus"></i> Nova graduação
				</a>
				<h1 class="h3 mb-2 text-gray-800">Graduação de alunos</h1>
				...
				<div class="row">
					...
					<div class="col-md-3 text-left mt-1">
						...
						href="{{ route('graduacao.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="9"
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								...
								<div class="dropdown no-arrow">
									...
									<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"aria-labelledby="dropdownMenuLink">
										...
										<form action="{{ route('graduacao.delete', $g->id) }}" method="post"
											id="form-{{$g->id}}">
											@csrf
							...
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										...
										<div class="h6 mb-0 font-weight-bold text-gray-800">
											Graduação: <strong>{{$g->faixa->nome}} {{$g->grau > 0 ? $g->grau . "º" : ''}}</strong>
										</div>
