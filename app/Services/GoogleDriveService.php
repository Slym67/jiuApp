...
class GoogleDriveService{
	...
	protected $OAUTH2_TOKEN_URI = 'https://oauth2.googleapis.com/token'; 
	protected $DRIVE_FILE_UPLOAD_URI = 'https://www.googleapis.com/upload/drive/v3/files'; 
	protected $DRIVE_FILE_META_URI = 'https://www.googleapis.com/drive/v3/files/';
	...
	public function UploadFileToDrive($access_token, $file_content, $mime_type) { 
		$apiURL = $this->DRIVE_FILE_UPLOAD_URI . '?uploadType=media'; 
